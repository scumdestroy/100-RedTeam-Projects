...
def find_hash(target, hash_type, wordlist):
    ...
    for result in results:
        ...
        if hashed_value == target:
            print(f"Big winner, my dude: {hashed_word}")
            break
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Multi-threaded Hash Puncher")
    parser.add_argument("target", type=str, help="Hash you intend to crack")
